<div class="wrap shailan_options_page">
	<?php screen_icon(); ?>
...
<div class="shailan_opts_wrap">
<div class="shailan_options">
<form method="post">
<div id="options-tabs">
	<!-- Tabs navigation -->
...
<?php break;
	case 'paragraph': ?>
<div class="shailan_paragraph clearfix">
	<?php echo $field['desc']; ?>
</div>
<?php
break;
	...
	case 'text': ?>
<div class="shailan_input shailan_text clearfix">
...
case 'textarea':
?>
<div class="shailan_input shailan_textarea clearfix">
	<label for="<?php echo $field['id']; ?>"><?php echo $field['name']; ?></label>
...
case 'select':
?>
<div class="shailan_input shailan_select clearfix">
	<label for="<?php echo $field['id']; ?>"><?php echo $field['name']; ?></label>
...
case "checkbox":
?>
<div class="shailan_input shailan_checkbox clearfix">
	<label for="<?php echo $field['id']; ?>"><?php echo $field['name']; ?></label>
	
	<input type="checkbox" name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" value="on" <?php if( isset( $current[ $field['id'] ] ) ){ checked( $current[ $field['id'] ], "on" ); }; ?> />
	<small><?php echo $field['desc']; ?></small>
 </div>
<?php break; 
case "section":
?>
<div class="shailan_section tab_content" id="<?php echo sanitize_title( $field['name'] ); ?>">
...
<p><small>You are seeing this code because <code>WP_DEBUG</code> is enabled in your WordPress installation.</small></p>
